...
function Sdropdown({flag, idDd,idDdM, sample, phone, label, register, name, handleOnSelect,selectedOption,options}) {
  ...
  return (
    <div style={{display: "flex", flexDirection: "column"}}>
      ...
      <UncontrolledDropdown isOpen={open} toggle={toggle} >
        <DropdownToggle  innerRef={register()}  caret color="" id="navbarDropdownMenuLink3" className="d-flex justify-content-between align-items-center mr-0" style={{ padding:'5px', backgroundColor:'#fff', border:'1px solid #707070', borderRadius:"25px"}}>
           <Image id={idDdM}
