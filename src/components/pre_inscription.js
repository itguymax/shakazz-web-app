...
const PreInscription = ({bleu}) => {
  return (
      ...
      `}>     
              ...
              `}/>
                <h2 className=" text-white">Reservez votre place </h2>
                <h2 className="text-white p-0 mt--2  mb-4"> en cliquant ici</h2>
              </div>
               <a href={config.preInscriptionLink}  target="_blank" style={{ background: bleu?'#cc993a 0% 0% no-repeat padding-box':'#24422F 0% 0% no-repeat padding-box', cursor:'pointer', width:"200px", textAlign:"center", padding:'12px 10px 12px 10px', borderRadius:'20px',  font: 'normal normal normal 16px/14px Ubuntu', color:'#fff', marginBottom: "20px"}}>Pré-inscription</a>
        </Container>
      </div>
    </>
