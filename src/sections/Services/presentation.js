          ...
          <Nav tabs>
              <NavItem className="services_page_section_presentation_tab">
                ...
                >
                  <Row>
                    <Col sm="3">
                      <img id="navImg1" src="/assets/img/icons/icon_activated.svg"/>
                    </Col>
                    <Col sm="9">
              ...
              <NavItem className="services_page_section_presentation_tab">
                ...
                >
                  <Row>
                    <Col sm="3">
                      <img id="navImg2" src="/assets/img/icons/icon_non-activated.svg"/>
                    </Col>
                    <Col sm="9">
               ...
               <NavItem className="services_page_section_presentation_tab">
                ...
                >
                   <Row>
                    <Col sm="3">
                      <img id="navImg3" src="/assets/img/icons/icon_non-activated.svg"/>
                    </Col>
                    <Col sm="9">
              ...
              <NavItem className="services_page_section_presentation_tab">
                ...
                >
                  <Row>
                    <Col sm="3">
                      <img id="navImg4" src="/assets/img/icons/icon_non-activated.svg"/>
                    </Col>
                    <Col sm="9">
               ...
               <NavItem className="services_page_section_presentation_tab">
                ...
                >
                  <Row>
                    <Col sm="3">
                      <img id="navImg5" src="/assets/img/icons/icon_non-activated.svg"/>
                    </Col>
                    <Col sm="9">
